...
let nameGreeting = nameCheck('Joseph')
...
//CODE HERE
const bestMovie = (movieTitle) => {String(movieTitle); return `${movieTitle} is the best movie ever!`}
...
////////////////// PROBLEM 16 ////////////////////ASK FOR HELP ON THIS ONE
...
emailCheck("niceemail@gmail.com")
...
//CODE HERE
//We don't have that bug I think because we did a while loop, when I put in 4 it comes out as 2.
// function froggies(gold){
//   return Math.floor(gold/3)
// }
// let totalFrogs2 = froggies(100)
